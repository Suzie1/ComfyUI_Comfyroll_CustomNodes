...
def draw_circle(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    radius = size / 2
    draw.ellipse([(center_x - radius, center_y - radius),
                  (center_x + radius, center_y + radius)], fill=color)

def draw_oval(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    draw.ellipse([(center_x - size / 2, center_y - size / 2 / aspect_ratio),
                  (center_x + size / 2, center_y + size / 2 / aspect_ratio)], fill=color)

def draw_diamond(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
...
def draw_square(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    draw.rectangle([(center_x - size / 2, center_y - size / 2),
                    (center_x + size / 2, center_y + size / 2)], fill=color)

def draw_triangle(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    draw.polygon([(center_x, center_y - size / 2),
                  (center_x + size / 2, center_y + size / 2),
                  (center_x - size / 2, center_y + size / 2)], fill=color)

def draw_hexagon(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    hexagon_points = [
        (center_x - size / 2, center_y),
...
def draw_octagon(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    octagon_points = [
...
def draw_half_circle(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    draw.pieslice([(center_x - size / 2, center_y - size / 2),
                   (center_x + size / 2, center_y + size / 2)], start=0, end=180, fill=color)

def draw_quarter_circle(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    draw.pieslice([(center_x - size / 2, center_y - size / 2),
                   (center_x + size / 2, center_y + size / 2)], start=0, end=90, fill=color)

def draw_starburst(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
...
def draw_star(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
    outer_radius = size / 4
...
def draw_cross(draw, center_x, center_y, size, aspect_ratio, num_rays, color):
